              ...
              <div className="add_cashpart">
                ...
                <form className="addcash_formpart">
                  <div className="form-group">
                    <AvField type="text" name="amountadded" className="form-control" min={1} ng-model="amount" onChange={this.onChange} value={this.state.amountadded} placeholder="Add amount" 
                     validate={{
