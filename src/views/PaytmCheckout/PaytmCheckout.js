    ...
    if (this.state.isVisible) {
      if (this.state.txtpromocode) {
        if (this.state.responsePC === "Applied") {
          ...
          } else if (this.props.match.params.payment_method === "cashfree") {
            window.location.href = HBRout + "/CashfreeRedirect/cashfree/" + atob(this.props.match.params.amount) + "/" + btoa(this.state.txtpromocode);
          }
        }
      }
      else {
      ...
      if (this.props.match.params.payment_method === "paytm") {
        ...
        window.location.href = HBRout + "/CashfreeRedirect/cashfree/" + atob(this.props.match.params.amount) + "/no";
      }
    }
  }
