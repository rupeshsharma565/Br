        ...
        if (chkresp === true) {
          response.json().then(json => {
            if (json.error===false) {             
              ...
              // formthis.setState({
              //   getTransactionHistoryList: json.data.list,    
              ...
              formthis.setState({
                ...
                hasMore: (formthis.state.getTransactionHistoryList.length < json.data.total),
                isLoading: false,
                getTransactionHistoryList: [
                  ...formthis.state.getTransactionHistoryList,
                  ...nextPageRecord,
                ],
              });
            }
      ...
      <div className="left_logincontent profilepadding0 scroll-height">
        <div className="background-cover ng-scope">
          <div className="header_bg">
            ...
            <div className="hd_center">Transaction History</div>
          </div>
		  ...
		  <li className="maintoops"> 
            ...
            <ul className="trans_historypt">
             ...
             {
               this.state.getTransactionHistoryList.map(function(item,index){
               return(
