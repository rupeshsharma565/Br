...
//         swal({
//           title: "Are you sure?",
//           text: "For joining, you have to pay "+joinamount+".",
//           icon: "warning",
//           buttons: [
//             'No, cancel it!',
//             'Yes, Join Team!'
...
joiningcontest=()=>{
  ...
  let reqapi = api_url + "/frontapi/joincontest";      
    fetch(reqapi, object)
        .then(function (response) {
          formthis.setState({
            isLoading: false
          ...
          this.setState({isDisable: false,isLoading: false});
          checkresponse("Wrong", false, error.toString(), 0);
        });
}
