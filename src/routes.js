...
const TermsCondition2 = React.lazy(() => import("./views/TermsCondition2"));
...
const FantasyPointSystem = React.lazy(() =>
  import("./views/FantasyPointSystem")
);
...
const CashfreeCheckout = React.lazy(() => import("./views/CashfreeCheckout"));
const CashfreeRedirect = React.lazy(() => import("./views/CashfreeRedirect"));
const CashfreeResponse = React.lazy(() => import("./views/CashfreeResponse"));
...
const KabaddiFullScoreCard = React.lazy(() =>
  import("./views/KabaddiFullScoreCard")
);
const FootballFullScoreCard = React.lazy(() =>
  import("./views/FootballFullScoreCard")
);
const CreatePrivateContest = React.lazy(() =>
  import("./views/CreatePrivateContest")
);
const Checkout = React.lazy(() => import("./views/Checkout"));
const CheckOutCashfree = React.lazy(() =>
  import("./views/Checkout/CheckOutCashfree")
);

const BalanceSheet = React.lazy(() => import("./views/BalanceSheet"));
...
const routes = [
  ...
  {
    path: "/CreateTeams/:matchid",
    name: "CreateTeams",
    component: CreateTeams
  },
  {
    path: "/UpdateTeams/:matchid/:teamid",
    name: "CreateTeams",
    component: CreateTeams
  },
  {
    path: "/CloneTeam/:matchid/:teamid",
    name: "CreateTeams",
    component: CreateTeams
  },
  ...
  {
    path: "/WithdrawlVerify",
    name: "WithdrawlVerify",
    component: WithdrawlVerify
  },
  {
    path: "/FantasyPointSystem",
    name: "FantasyPointSystem",
    component: FantasyPointSystem
  },
  { path: "/AddCash", name: "AddCash", component: AddCash },

  {
    path: "/JoinContest/:matchid/:type",
    name: "JoinContestType",
    component: JoinContest
  },
  {
    path: "/JoinContest/:matchid",
    name: "JoinContest",
    component: JoinContest
  },
  {
    path: "/ChooseTeam/:matchid/:poolid/:joincost",
    name: "ChooseTeam",
    component: ChooseTeam
  },
  {
    path: "/ChoosePrivateTeam/:matchid/:responsejoin",
    name: "ChoosePrivateTeam",
    component: ChoosePrivateTeam
  },
  {
    path: "/SwitchTeam/:matchid/:poolid",
    name: "SwitchTeam",
    component: SwitchTeam
  },
  {
    path: "/ContestDetails/:matchid/:poolcontestid/:type",
    name: "ContestDetailsType",
    component: ContestDetails
  },
  {
    path: "/ContestDetails/:matchid/:poolcontestid",
    name: "ContestDetails",
    component: ContestDetails
  },
  {
    path: "/ContestDetailsForJoin/:matchid/:poolcontestid",
    name: "ContestDetailsJoin",
    component: ContestDetails
  },
  { path: "/MyMatches", name: "MyMatches", component: MyMatches },
  { path: "/LiveScore", name: "LiveScore", component: LiveScore },
  {
    path: "/FullScoreCard/1/:matchid",
    name: "FullScoreCard",
    component: FullScoreCard
  },
  {
    path: "/FullScoreCard/2/:matchid",
    name: "FootballFullScoreCard",
    component: FootballFullScoreCard
  },
  {
    path: "/FullScoreCard/3/:matchid",
    name: "KabaddiFullScoreCard",
    component: KabaddiFullScoreCard
  },
  {
    path: "/Checkout/:payment_method/:orderid/:amount",
    name: "Checkout",
    component: PaytmCheckout
  },
  {
    path: "/PaytmRedirect/:orderid/:amount/:promocode",
    name: "PaytmRedirect",
    component: PaytmRedirect
  },
  {
    path: "/PaytmResponse/:orderid/:txid",
    name: "PaytmResponse",
  ...
  {
    path: "/CashfreeRedirect/:orderid/:amount/:promocode",
    name: "CashfreeRedirect",
    component: CashfreeRedirect
  },
  {
    path: "/CashfreeResponse/:orderid/:txid",
    name: "CashfreeResponse",
    component: CashfreeResponse
  },
  {
  ...
  {
    path: "/FantasyScoreCard/:gameid/:matchid",
    name: "FantasyScoreCard",
    component: FantasyScoreCard
  },
  ...
  {
    path: "/CreatePrivateContest/:matchid/",
    name: "Create Private Contest",
    component: CreatePrivateContest
  },
  {
    path: "/RazorpayCheckout/:type/:amount/:promocode",
    name: "RazorpayCheckout",
    component: Checkout
  },
  {
    path: "/CashfreeCheckout/:type/:amount/:promocode",
    name: "CashfreeCheckout",
    component: CheckOutCashfree
  },
  {
    path: "/BalanceSheet",
    name: "BalanceSheet",
